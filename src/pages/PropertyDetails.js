...
const PropertyDetails = () => {
  ...
  return (
    <section>
      <div className=" container mx-auto min-h-[900px] mb-14 ">
          ...
          <div className=" flex-1 bg-white-100 w-full mb-8 border border-gray-300 rounded-lg px-6 py-8  ">
            ...
            <form className=" flex flex-col gap-y-4 " >
              ...
              <div className=" flex gap-x-2 " >
                <button className=" bg-blue-800 hover:bg-violet-800 text-white rounded p-4 text-sm w-full transition ">
                  Send Message
                </button>
                <button className=" border border-blue-800 text-blue-800 hover:border-violet-500 hover:text-violet-500 rounded p-4 text-sm w-full transition ">
                  Call
                </button>
              </div>
            </form>
